...
public class PlantWateringService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if (ACTION_WATER_PLANT.equals(action)) {
                long id = intent.getLongExtra(EXTRA_PLANT_ID, PlantContract.PlantEntry.INVALID_PLANT_ID);
                handleActionWaterPlant(id);
    ...
    private void handleActionWaterPlant(long plantId) {
        ...
        // Update plant with plantId if it's still alive
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        long plantId = PlantContract.PlantEntry.INVALID_PLANT_ID;
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            cursor.close();
            canWater = (timeNow - createdAt) > MIN_AGE_BETWEEN_WATER &&
